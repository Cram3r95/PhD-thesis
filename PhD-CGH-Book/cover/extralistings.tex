...
% Include acronyms (CGH)

\ifthenelse{\equal{\myLanguage}{english}}
{
	\listof{codefloat}{List of Acronyms}
	\addcontentsline{toc}{chapter}{List of Acronyms}
}
{
	\listof{codefloat}{Índice de listado de acrónimos}    
	\addcontentsline{toc}{chapter}{Índice de listado de acrónimos}
}
