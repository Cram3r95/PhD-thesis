...
We use the Argoverse 2~\cite{wilson2023argoverse} dataset described in Section \ref{sec:2_motion_prediction_datasets}. %The Argoverse 2 dataset is a high-quality multi-agent motion prediction dataset. 
