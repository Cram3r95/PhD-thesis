...
The simulator runs at 13 fps over a computer
consisting of an Intel i7-9700k (overclocked to 4.9 GHz), NVIDIA 2080 Ti and 32 GB of
RAM (3200 MHz).
...
In terms of the decision-making application, the proposed method incorporates an Efficient Social-based Motion Prediction module, which predicts the future positions of vehicles within the scenario. These predictions improve a Reinforcement Learning-based Decision Making module. The results of the study demonstrate that our approach achieves significant performance improvements, particularly in scenarios involving high velocities.

Moreover, the scope of your thesis may limit the extent to which you can tackle the complexities of developing a comprehensive detector and tracker for multiple obstacles. Such an endeavor would likely require a significant amount of time, resources, and expertise, potentially extending beyond the time frame and objectives of your research. By choosing to work with ray-tracing-based ground-truth, you can prioritize the main focus of your thesis—motion prediction—while still incorporating a realistic and accurate representation of the environment. This decision ensures that your research remains focused, feasible, and aligned with the intended objectives.

In conclusion, justifying the use of ray-tracing-based ground-truth instead of coding a detector and tracker for multiple obstacles in a 360º autonomous driving scenario is a reasonable approach given the limitations and purpose of your thesis. It allows you to achieve meaningful results in motion prediction while avoiding the extensive workload and technical complexities associated with developing a comprehensive obstacle detection and tracking system. By leveraging the realistic nature of ray-tracing-based ground-truth, you can provide reliable input data, optimize computational efficiency, and maintain focus on your research objectives. 
