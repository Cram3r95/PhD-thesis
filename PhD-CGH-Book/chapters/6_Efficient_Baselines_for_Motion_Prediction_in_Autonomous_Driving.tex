...
\label{subsubsec:6_efficient_baselines_social_preprocessing}
...
\label{subsubsec:6_efficient_baselines_map_baseline}
...
We illustrate the qualitative results of our best model (Augmented baseline).
...
In order to calculate the FLOPs, we follow the common practice \cite{gao2020vectornet} \cite{gu2021densetnt} \cite{gilles2022gohome} of fixing the number of lanes \emph{i.e.,} the number of centerlines is limited to 3. %, since we focus on the plausible area around the target agent.
