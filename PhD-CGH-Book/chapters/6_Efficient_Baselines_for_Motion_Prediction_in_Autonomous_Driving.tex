...
We prove our best model (Augmented baseline) qualitatively in Figure \ref{fig:chapter_6_Efficient_Baselines/argoverse_1_qualitative_results}, where we can see how the estimated centerlines represent a good guidance for the model and the multi-modal prediction works accordingly specifically in challenging intersections.
