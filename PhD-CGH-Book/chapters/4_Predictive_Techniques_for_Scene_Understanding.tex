...
\begin{figure}[h] 
	\centering
	\includegraphics[width=0.5\textwidth]{4_lanegcn_map_representation.pdf}
...
\begin{figure}[t]                                                                                                                           
	\begin{center}
		\includegraphics[width=0.6\linewidth]{4_lanegcn_scheme.pdf}
	\end{center}
...
Here, we employ a WTA strategy to optimize the offset and angle losses, similar to the first stage. The total loss in the second stage can be expressed as: 
