...
\newcommand{\myThesisKeywords}{Conducción Autónoma, Predicción de Movimiento, Aprendizaje Profundo, Entendimiento de la Escena, Eficiencia, Simulación} % (máximo de cinco)
\newcommand{\myThesisKeywordsEnglish}{Autonomous Driving, Motion Prediction, Deep Learning, Scene Understanding, Efficiency, Simulation} % (up to a maximum of five)
...
\newcommand{\myResearchGroup}{RobeSafe research group}
...
\newcommand{\myThesisDepositDateEnglish}{TBD}

% For RR, myThesisDefenseDate is date to be shown in the cover
\newcommand{\myThesisDefenseYear}{2023}
%\newcommand{\myThesisDefenseDate}{September 28th}
%\newcommand{\myThesisdefenseDateEnglish}{TBD}
% If you prefer British English for the date, use this:
\newcommand{\myThesisdefenseDateEnglish}{28\textsuperscript{th} of September, 2023}
...
\newcommand{\myalgorithmslinkcolor}{black}
